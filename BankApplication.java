/*
# 🏦 Bank Application (Java, OOP)

## 📌 Overview
This **Bank Application** is a simple Java-based banking system that allows users to **create accounts, deposit money, withdraw funds, and check balances**. The project follows **Object-Oriented Programming (OOP)** principles, ensuring code reusability and efficiency.
...
✔ **Manage multiple accounts** using a `HashMap`  

## 🛠️ Technologies Used
- **Java** (Core Java, OOP concepts)
- **HashMap** (for efficient account storage)
